...
**Sprint 4 is active:** Building the Shield binary + supporting Controller/Connector changes.
...
Step 2: Read .zecurity-obs/Sprint4/path.md  → dependency map + checkboxes
...
- **`.zecurity-obs/Sprint4/path.md`** — ordered execution with checkboxes (source of truth for what's done)
- **`.zecurity-obs/Sprint4/Member{1-4}-*/Phase*.md`** — per-phase implementation specs
...
1. Mark completed phase checkboxes in `.zecurity-obs/Sprint4/path.md`
