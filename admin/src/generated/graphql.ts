...
export type GetRemoteNetworksQuery = { __typename?: 'Query', remoteNetworks: Array<{ __typename?: 'RemoteNetwork', id: string, name: string, location: NetworkLocation, status: RemoteNetworkStatus, createdAt: string, connectors: Array<{ __typename?: 'Connector', id: string, name: string, status: ConnectorStatus, lastSeenAt?: string | null, version?: string | null, hostname?: string | null, publicIp?: string | null, certNotAfter?: string | null, createdAt: string }>, shields: Array<{ __typename?: 'Shield', id: string, name: string, status: ShieldStatus, lastSeenAt?: string | null, version?: string | null, hostname?: string | null, interfaceAddr?: string | null, connectorId: string }> }> };
...
export type GetConnectorsQuery = { __typename?: 'Query', connectors: Array<{ __typename?: 'Connector', id: string, name: string, status: ConnectorStatus, lastSeenAt?: string | null, version?: string | null, hostname?: string | null, publicIp?: string | null, certNotAfter?: string | null, createdAt: string }> };
...
export type GetShieldsQuery = { __typename?: 'Query', shields: Array<{ __typename?: 'Shield', id: string, name: string, status: ShieldStatus, lastSeenAt?: string | null, version?: string | null, hostname?: string | null, publicIp?: string | null, interfaceAddr?: string | null, certNotAfter?: string | null, createdAt: string, connectorId: string }> };
