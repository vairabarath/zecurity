...
export type CreateResourceInput = {
  ...
  localTarget?: InputMaybe<Scalars['String']['input']>;
...
export type Mutation = {
  ...
  reenrollConnector: Scalars['Boolean']['output'];
  reenrollShield: Scalars['Boolean']['output'];
...
export type MutationReenrollConnectorArgs = {
  id: Scalars['ID']['input'];
};


export type MutationReenrollShieldArgs = {
  id: Scalars['ID']['input'];
};
...
export type Resource = {
  ...
  localTarget?: Maybe<Scalars['String']['output']>;
  name: Scalars['String']['output'];
...
export type ReenrollConnectorMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type ReenrollConnectorMutation = { __typename?: 'Mutation', reenrollConnector: boolean };
...
export type ReenrollShieldMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type ReenrollShieldMutation = { __typename?: 'Mutation', reenrollShield: boolean };
...
export type CreateResourceMutation = { __typename?: 'Mutation', createResource: { __typename?: 'Resource', id: string, name: string, description?: string | null, host: string, hostname?: string | null, resolver?: string | null, localTarget?: string | null, protocol: string, portFrom: number, portTo: number, status: string, shield?: { __typename?: 'Shield', id: string, name: string } | null } };
...
export type UpdateResourceMutation = { __typename?: 'Mutation', updateResource: { __typename?: 'Resource', id: string, name: string, description?: string | null, host: string, hostname?: string | null, resolver?: string | null, localTarget?: string | null, protocol: string, portFrom: number, portTo: number, status: string } };
...
export type GetAllResourcesQuery = { __typename?: 'Query', allResources: Array<{ __typename?: 'Resource', id: string, name: string, description?: string | null, host: string, hostname?: string | null, resolver?: string | null, localTarget?: string | null, protocol: string, portFrom: number, portTo: number, status: string, errorMessage?: string | null, appliedAt?: string | null, lastVerifiedAt?: string | null, createdAt: string, shield?: { __typename?: 'Shield', id: string, name: string, status: ShieldStatus, lanIp?: string | null } | null, remoteNetwork: { __typename?: 'RemoteNetwork', id: string, name: string }, groups: Array<{ __typename?: 'Group', id: string, name: string, origin: string, connectionId?: string | null }> }> };
...
export type GetResourcesQuery = { __typename?: 'Query', resources: Array<{ __typename?: 'Resource', id: string, name: string, description?: string | null, host: string, hostname?: string | null, resolver?: string | null, localTarget?: string | null, protocol: string, portFrom: number, portTo: number, status: string, errorMessage?: string | null, lastVerifiedAt?: string | null, appliedAt?: string | null, createdAt: string, shield?: { __typename?: 'Shield', id: string, name: string, status: ShieldStatus } | null }> };
...
export type GetGroupsQuery = { __typename?: 'Query', groups: Array<{ __typename?: 'Group', id: string, name: string, description?: string | null, origin: string, connectionId?: string | null, createdAt: string, updatedAt: string, members: Array<{ __typename?: 'User', id: string, email: string, role: Role }>, resources: Array<{ __typename?: 'Resource', id: string, name: string, host: string, hostname?: string | null, protocol: string, portFrom: number, portTo: number }> }> };
...
export type GetGroupQuery = { __typename?: 'Query', group?: { __typename?: 'Group', id: string, name: string, description?: string | null, origin: string, connectionId?: string | null, createdAt: string, updatedAt: string, members: Array<{ __typename?: 'User', id: string, email: string, role: Role }>, resources: Array<{ __typename?: 'Resource', id: string, name: string, host: string, hostname?: string | null, protocol: string, portFrom: number, portTo: number }> } | null };
...
export const ReenrollConnectorDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ReenrollConnector"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"reenrollConnector"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<ReenrollConnectorMutation, ReenrollConnectorMutationVariables>;
...
export const ReenrollShieldDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ReenrollShield"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"reenrollShield"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<ReenrollShieldMutation, ReenrollShieldMutationVariables>;
