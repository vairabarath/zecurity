...
export type GetConnectorLogsQuery = { __typename?: 'Query', connectorLogs: Array<{ __typename?: 'ConnectorLog', id: string, workspaceId: string, connectorId: string, message: string, createdAt: string }> };
